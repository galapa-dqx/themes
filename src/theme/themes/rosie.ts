...
export const rosie: AuthoringTheme = {
  ...
  tokens: {
    ...
    text: {
      heading: { family: 'Inter', fallback: 'sans-serif', weight: 400, style: 'normal', size: 14, letterSpacing: 0, case: 'none' },
      body: { family: 'Source Sans 3', fallback: 'sans-serif', weight: 400, style: 'normal', size: 14, letterSpacing: 0, case: 'none' },
      strong: { family: 'Inter', fallback: 'sans-serif', weight: 400, style: 'normal', size: 14, letterSpacing: 0, case: 'none' },
    },
  },
  controls: {
