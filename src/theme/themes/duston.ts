...
export const duston: AuthoringTheme = {
  ...
  controls: {
    ...
    button: {
      ...
      text: { style: '--text-strong', size: 16, letterSpacing: 0.6, case: 'uppercase' },
      states: {
    ...
    'news-item': {
      ...
      padding: [0, 12, 0, 12],
      contentColor: '--color-muted',
      text: { style: '--text-strong', size: 16, letterSpacing: 0.4 },
      states: {
    ...
    'titlebar.wordmark': {
      contentColor: '--color-accent',
      text: { style: '--text-heading', size: 20, letterSpacing: 0.4, case: 'uppercase' },
    },
